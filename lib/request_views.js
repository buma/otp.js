...
var requestFormTemplate = Handlebars.compile([
                ...
                '<div class="visibleSettings">',
                    ...
                    '<div class="row fromPlaceControl">', 
                        '<input disabled class="apiParam col-sm-12" id="fromPlace" placeholder="Start Address"/>',
                    '</div>', 
                    '<div class="row toPlaceControl">', 
                        '<input disabled id="toPlace" class="apiParam col-sm-12" placeholder="End Address"/>', 
                    '</div>', 
                ...
                '<div id="hidableSettings">',
                    ...
                    '<div class="row timeControl">', 
                        '<div class="input-group date col-md-12" id="time">', 
                            '<input type="text" class="form-control apiParam" data-format="hh:mm"/>', 
                            '<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>', 
                        '</div>', 
                    '</div>', 
                    '<div class="row dateControl">', 
                        '<div class="input-group date col-md-12" id="date">', 
                            '<input type="text" class="form-control apiParam" data-format="dd.MM.yyyy"/>', 
                            '<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>', 
                        '</div>', 
                    '</div>', 
...
var OtpRequestFormView = Backbone.View.extend({
    ...
    initialize : function(options) {
        ...
        this.model.on("change", function(data) {
            ...
            var date = moment(data.attributes.date, "DD.MM.YYYY").toDate();
            view.datepicker.setLocalDate(date);

            var time = moment(data.attributes.time, "HH:mm").toDate();
    ...
    render : function() {
        ...
        var html = requestFormTemplate({
            metric: this.options.metric || true
        });
